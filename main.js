...
function gotResult(error, results) {
  ...
  console.log(results);
  document.getElementById('random').innerHTML = 'random: ' + res[Math.floor(Math.random())];

  document.getElementById('label').innerHTML = 'Label: ' + results[0].label;

  if(document.getElementById('label').value==document.getElementById('random')){
    document.getElementById('score').innerHTML = 'score: ' + scored+1;
  }
  else{
